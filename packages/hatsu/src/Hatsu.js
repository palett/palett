import { hexToRgb, hslToRgb, rgbToInt } from '@palett/convert'
...
export class Hatsu extends Callable {
   ...
   */
  static rgb(arr) { return new Hatsu(arr) }
   ...
   * @returns {Hatsu|function}
   */
  static hex(str) { return Hatsu.rgb(hexToRgb(str)) }
   ...
   * @returns {Hatsu|function}
   */
  static hsl(arr) { return Hatsu.rgb(hslToRgb(arr)) }
