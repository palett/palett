...
import { BlendDye, hslToDye, presetToFlatDye, presetToLeap } from '@palett/util-fluo'
import { isNumeric } from '@typen/num-strict'
import { boundToLeap } from '../utils/boundToLeap'

export const FluoNumber = (bound, preset = PLANET, colorant = true) => {
  const vleap = boundToLeap(bound), cleap = presetToLeap(preset), prime = presetToFlatDye(preset)
  let dye
