...
function hslToRgb(hsl) {
  ...
  const au = s * Math.min(l, 1 - l),
        ...
        g = hf(8, h, au, l),
        b = hf(4, h, au, l);
  return (this ?? Array)(math.round(r * 0xFF), math.round(g * 0xFF), math.round(b * 0xFF)); // return [r * 0xFF & 0xFF, g * 0xFF & 0xFF, b * 0xFF & 0xFF]
}
...
function fracToHsl(r, g, b) {
  ...
  const h = hue(r, g, b, hi, df) * 60,
        ...
        l = sm / 2;
  return this(math.round(h), math.round(s * math.E3) / 10, math.round(l * math.E3) / 10);
}
